...
with torch.no_grad():
    ...
    ax1.scatter(x1_plot, x2_plot, u_pred_plot[:, 0], c=u_pred_plot[:, 0], cmap='RdYlGn')
    ax1.set_xlabel('x1')
    ax1.set_ylabel('x2')
    ax1.set_zlabel('u1')
    ax1.set_title('Predictions for u1')

    ax2 = fig.add_subplot(122, projection='3d')
    ax2.scatter(x1_plot, x2_plot, u_pred_plot[:, 1], c=u_pred_plot[:, 1], cmap='RdYlGn')
    ax2.set_xlabel('x1')
    ax2.set_ylabel('x2')
    ax2.set_zlabel('u2')
    ax2.set_title('Predictions for u2')
